 ...
 ******************************************************************************/
BigGlyphMetrics::BigGlyphMetrics(ReadableFontData* data) : GlyphMetrics(data) {}

BigGlyphMetrics::~BigGlyphMetrics() {}

int32_t BigGlyphMetrics::Height() { return data_->ReadByte(Offset::kHeight); }

int32_t BigGlyphMetrics::Width() { return data_->ReadByte(Offset::kWidth); }
...
CALLER_ATTACH FontDataTable* BigGlyphMetrics::Builder::SubBuildTable(
...
int32_t BigGlyphMetrics::Builder::SubDataSizeToSerialize() { return 0; }

bool BigGlyphMetrics::Builder::SubReadyToSerialize() { return false; }
