...
class BitmapSizeTable : public SubTable, public RefCounted<BitmapSizeTable> {
 public:
  class Builder : public SubTable::Builder, public RefCounted<Builder> {
   public:
 ...
 protected:
  BitmapSizeTable(ReadableFontData* data, ReadableFontData* master_data);
