...
CompositeBitmapGlyph::Component CompositeBitmapGlyph::GetComponent(
  ...
  int32_t component_offset =
      component_array_offset_ + component_num * Offset::kEbdtComponentLength;
...
void CompositeBitmapGlyph::Initialize(int32_t format) {
  if (format == 8) {
    ...
    throw IllegalStateException(
        "Attempt to create a Composite Bitmap Glyph "
...
CompositeBitmapGlyph::Component::Component(int32_t glyph_code, int32_t x_offset,
                                           int32_t y_offset)
...
CALLER_ATTACH FontDataTable* CompositeBitmapGlyph::Builder::SubBuildTable(
