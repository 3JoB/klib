...
class IndexSubTableFormat3 : public IndexSubTable,
 ...
 public:
  class Builder : public IndexSubTable::Builder, public RefCounted<Builder> {
   public:
  ...
  static int32_t GetDataLength(ReadableFontData* data, int32_t offset,
                               int32_t first, int32_t last);

 private:
  IndexSubTableFormat3(ReadableFontData* data, int32_t first_glyph_index,
                       int32_t last_glyph_index);
