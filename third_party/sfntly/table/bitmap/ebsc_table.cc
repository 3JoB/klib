...
int32_t EbscTable::Version() { return data_->ReadFixed(Offset::kVersion); }
...
int32_t EbscTable::Builder::SubDataSizeToSerialize() { return 0; }

bool EbscTable::Builder::SubReadyToSerialize() { return false; }
