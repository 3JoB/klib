...
int32_t SmallGlyphMetrics::Height() { return data_->ReadByte(Offset::kHeight); }

int32_t SmallGlyphMetrics::Width() { return data_->ReadByte(Offset::kWidth); }
...
CALLER_ATTACH FontDataTable* SmallGlyphMetrics::Builder::SubBuildTable(
...
int32_t SmallGlyphMetrics::Builder::SubDataSizeToSerialize() { return 0; }

bool SmallGlyphMetrics::Builder::SubReadyToSerialize() { return false; }
