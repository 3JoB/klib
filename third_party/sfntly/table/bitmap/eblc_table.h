...
class EblcTable : public SubTableContainerTable, public RefCounted<EblcTable> {
 public:
  struct Offset {
    enum {
      // header
      ...
      kIndexSubTable4_glyphArray = kIndexSubTable4_numGlyphs + DataSize::kULONG,
      ...
      kIndexSubTable5_bigGlyphMetrics =
          kIndexSubTable5_imageSize + DataSize::kULONG,
      kIndexSubTable5_numGlyphs = kIndexSubTable5_bigGlyphMetrics +
                                  BitmapGlyph::Offset::kBigGlyphMetricsLength,
      kIndexSubTable5_glyphArray = kIndexSubTable5_numGlyphs + DataSize::kULONG,
 ...
 private:
  ...
  static void CreateBitmapSizeTable(ReadableFontData* data, int32_t num_sizes,
