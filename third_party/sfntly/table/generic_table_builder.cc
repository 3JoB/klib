...
// static
CALLER_ATTACH GenericTableBuilder* GenericTableBuilder::CreateBuilder(
    Header* header, WritableFontData* data) {
  Ptr<GenericTableBuilder> builder = new GenericTableBuilder(header, data);
  return builder.Detach();
}

GenericTableBuilder::GenericTableBuilder(Header* header, WritableFontData* data)
    : TableBasedTableBuilder(header, data) {}

GenericTableBuilder::GenericTableBuilder(Header* header, ReadableFontData* data)
    : TableBasedTableBuilder(header, data) {}
