...
CMapTable::CMapId CMapTable::WINDOWS_BMP = {PlatformId::kWindows,
                                            WindowsEncodingId::kUnicodeUCS2};
CMapTable::CMapId CMapTable::WINDOWS_UCS4 = {PlatformId::kWindows,
                                             WindowsEncodingId::kUnicodeUCS4};
CMapTable::CMapId CMapTable::MAC_ROMAN = {PlatformId::kWindows,
...
CALLER_ATTACH CMapTable::CMap* CMapTable::GetCMap(
    const CMapTable::CMapId cmap_id) {
...
int32_t CMapTable::Version() { return data_->ReadUShort(Offset::kVersion); }

int32_t CMapTable::NumCMaps() { return data_->ReadUShort(Offset::kNumTables); }
...
CMapTable::CMapIdFilter::CMapIdFilter(const CMapId wanted_id)
    : wanted_id_(wanted_id), comparator_(NULL) {}

CMapTable::CMapIdFilter::CMapIdFilter(const CMapId wanted_id,
                                      const CMapIdComparator* comparator)
    : wanted_id_(wanted_id), comparator_(comparator) {}

bool CMapTable::CMapIdFilter::accept(const CMapId& cmap_id) const {
  if (!comparator_) return wanted_id_ == cmap_id;
...
CALLER_ATTACH CMapTable::CMap::Builder* CMapTable::CMap::Builder::GetBuilder(
    ReadableFontData* data, int32_t offset, const CMapId& cmap_id) {
  ...
  switch (format) {
    ...
    case CMapFormat::kFormat2:
      ...
      fprintf(stderr,
              "Requesting Format2 builder, but it's unsupported; "
              "returning NULL\n");
#endif
      break;
...
CMapTable::CMap::Builder::Builder(ReadableFontData* data, int32_t format,
                                  const CMapId& cmap_id)
...
CMapTable::CMap::Builder::Builder(WritableFontData* data, int32_t format,
                                  const CMapId& cmap_id)
    : SubTable::Builder(data),
      format_(format),
      cmap_id_(cmap_id),
...
bool CMapTable::CMap::Builder::SubReadyToSerialize() { return true; }
...
CMapTable::CMapFormat0::CharacterIterator::CharacterIterator(int32_t start,
                                                             int32_t end)
    : character_(start), max_character_(end) {}
...
CMapTable::CMapFormat0::Builder::NewInstance(WritableFontData* data,
  ...
  if (data) {
    wdata.Attach(down_cast<WritableFontData*>(data->Slice(
        offset, data->ReadUShort(offset + Offset::kFormat0Length))));
  }
...
CMapTable::CMapFormat0::Builder::NewInstance(ReadableFontData* data,
  ...
  if (data) {
    rdata.Attach(down_cast<ReadableFontData*>(data->Slice(
        offset, data->ReadUShort(offset + Offset::kFormat0Length))));
  }
...
CMapTable::CMapFormat0::Builder::Builder(ReadableFontData* data, int32_t offset,
                                         const CMapId& cmap_id)
    : CMapTable::CMap::Builder(data, CMapFormat::kFormat0, cmap_id) {
  UNREFERENCED_PARAMETER(offset);
}
...
int32_t CMapTable::CMapFormat2::Language() { return 0; }
 ...
 ******************************************************************************/
CMapTable::CMapFormat2::Builder::Builder(WritableFontData* data, int32_t offset,
                                         const CMapId& cmap_id)
    : CMapTable::CMap::Builder(
          data ? down_cast<WritableFontData*>(data->Slice(
                     offset, data->ReadUShort(offset + Offset::kFormat0Length)))
...
CMapTable::CMapFormat2::Builder::Builder(ReadableFontData* data, int32_t offset,
                                         const CMapId& cmap_id)
    : CMapTable::CMap::Builder(
          data ? down_cast<ReadableFontData*>(data->Slice(
                     offset, data->ReadUShort(offset + Offset::kFormat0Length)))
...
int32_t CMapTable::CMapFormat4::GlyphId(int32_t character) {
  int32_t segment = data_->SearchUShort(
      StartCodeOffset(seg_count_), DataSize::kUSHORT, Offset::kFormat4EndCount,
      DataSize::kUSHORT, seg_count_, character);
  if (segment == -1) {
    return CMapTable::NOTDEF;
  }
...
int32_t CMapTable::CMapFormat4::RetrieveGlyphId(int32_t segment,
  ...
  return data_->ReadUShort(id_range_offset + IdRangeOffsetLocation(segment) +
                           2 * (character - start_code));
}

int32_t CMapTable::CMapFormat4::seg_count() { return seg_count_; }

int32_t CMapTable::CMapFormat4::Length() { return Length(data_); }
...
int32_t CMapTable::CMapFormat4::StartCode(ReadableFontData* data,
                                          int32_t seg_count, int32_t index) {
  int32_t start_code =
      data->ReadUShort(StartCodeOffset(seg_count) + index * DataSize::kUSHORT);
  return start_code;
}

// static
int32_t CMapTable::CMapFormat4::StartCodeOffset(int32_t seg_count) {
  int32_t start_code_offset =
      Offset::kFormat4EndCount + (seg_count + 1) * DataSize::kUSHORT;
...
int32_t CMapTable::CMapFormat4::EndCode(ReadableFontData* data,
  ...
  int32_t end_code =
      data->ReadUShort(Offset::kFormat4EndCount + index * DataSize::kUSHORT);
  return end_code;
}
...
int32_t CMapTable::CMapFormat4::IdDelta(ReadableFontData* data,
                                        int32_t seg_count, int32_t index) {
  int32_t id_delta =
      data->ReadUShort(IdDeltaOffset(seg_count) + index * DataSize::kUSHORT);
  return id_delta;
}
...
int32_t CMapTable::CMapFormat4::IdRangeOffset(ReadableFontData* data,
                                              int32_t seg_count,
                                              int32_t index) {
  int32_t id_range_offset = data->ReadUShort(IdRangeOffsetOffset(seg_count) +
...
int32_t CMapTable::CMapFormat4::IdRangeOffsetOffset(int32_t seg_count) {
  int32_t id_range_offset_offset = Offset::kFormat4EndCount +
                                   (2 * seg_count + 1) * DataSize::kUSHORT +
...
int32_t CMapTable::CMapFormat4::GlyphIdArrayOffset(int32_t seg_count) {
  int32_t glyph_id_array_offset = Offset::kFormat4EndCount +
                                  (3 * seg_count + 1) * DataSize::kUSHORT +
                                  seg_count * DataSize::kSHORT;
...
int32_t CMapTable::CMapFormat4::IdDelta(int32_t segment) {
  if (IsValidIndex(segment)) return IdDelta(data_, seg_count_, segment);
  return -1;
}
...
int32_t CMapTable::CMapFormat4::Language() { return Language(data_); }
...
void CMapTable::CMapFormat4::Builder::Segment::set_start_count(
    int32_t start_count) {
  start_count_ = start_count;
}
...
void CMapTable::CMapFormat4::Builder::Segment::set_end_count(
    int32_t end_count) {
  end_count_ = end_count;
}
...
void CMapTable::CMapFormat4::Builder::Segment::set_id_delta(int32_t id_delta) {
  id_delta_ = id_delta;
}
...
void CMapTable::CMapFormat4::Builder::Segment::set_id_range_offset(
    int32_t id_range_offset) {
  id_range_offset_ = id_range_offset;
}

// static
CALLER_ATTACH SegmentList* CMapTable::CMapFormat4::Builder::Segment::DeepCopy(
    SegmentList* original) {
  SegmentList* list = new SegmentList;
  for (SegmentList::iterator it = original->begin(), e = original->end();
       it != e; ++it) {
    list->push_back(*it);
  }
  return list;
...
CMapTable::CMapFormat4::Builder::NewInstance(ReadableFontData* data,
  ...
  if (data) {
    rdata.Attach(down_cast<ReadableFontData*>(data->Slice(
        offset, data->ReadUShort(offset + Offset::kFormat4Length))));
  }
...
void CMapTable::CMapFormat4::Builder::Initialize(ReadableFontData* data) {
  ...
  for (int32_t index = 0; index < seg_count; ++index) {
    ...
    segment->set_id_range_offset(
        CMapFormat4::IdRangeOffset(data, seg_count, index));
...
void CMapTable::CMapFormat4::Builder::set_glyph_id_array(
    std::vector<int32_t>* glyph_id_array) {
  glyph_id_array_.assign(glyph_id_array->begin(), glyph_id_array->end());
  set_model_changed();
}

CALLER_ATTACH FontDataTable* CMapTable::CMapFormat4::Builder::SubBuildTable(
    ReadableFontData* data) {
...
int32_t CMapTable::CMapFormat4::Builder::SubDataSizeToSerialize() {
  ...
  int32_t size = Offset::kFormat4FixedSize +
                 segments_.size() * (3 * DataSize::kUSHORT + DataSize::kSHORT) +
...
int32_t CMapTable::CMapFormat4::Builder::SubSerialize(
...
int32_t CMapTable::Builder::SubSerialize(WritableFontData* new_data) {
  int32_t size = new_data->WriteUShort(CMapTable::Offset::kVersion, version_);
...
bool CMapTable::Builder::SubReadyToSerialize() {
  if (GetCMapBuilders()->empty()) return false;

  // check each table
  for (CMapBuilderMap::iterator it = GetCMapBuilders()->begin(),
                                e = GetCMapBuilders()->end();
       it != e; ++it) {
    if (!it->second->SubReadyToSerialize()) return false;
  }
  return true;
}

int32_t CMapTable::Builder::SubDataSizeToSerialize() {
  if (GetCMapBuilders()->empty()) return 0;

  bool variable = false;
  int32_t size =
      CMapTable::Offset::kEncodingRecordStart +
...
CALLER_ATTACH CMapTable::Builder* CMapTable::Builder::CreateBuilder(
...
CALLER_ATTACH CMapTable::CMap::Builder* CMapTable::Builder::CMapBuilder(
    ReadableFontData* data, int32_t index) {
...
int32_t CMapTable::Builder::NumCMaps() { return GetCMapBuilders()->size(); }
