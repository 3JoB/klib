...
int32_t FontHeaderTable::XMin() { return data_->ReadUShort(Offset::kXMin); }

int32_t FontHeaderTable::YMin() { return data_->ReadUShort(Offset::kYMin); }

int32_t FontHeaderTable::XMax() { return data_->ReadUShort(Offset::kXMax); }

int32_t FontHeaderTable::YMax() { return data_->ReadUShort(Offset::kYMax); }
...
int32_t FontHeaderTable::Builder::IndexToLocFormat() {
  ...
  if (!table) return IndexToLocFormat::kInvalidOffset;
...
CALLER_ATTACH FontHeaderTable::Builder* FontHeaderTable::Builder::CreateBuilder(
