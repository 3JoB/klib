 ...
 public:
  ...
  class CMapIdFilter : public CMapFilter {
   public:
    ...
    CMapIdFilter(const CMapId wanted_id, const CMapIdComparator* comparator);
    ~CMapIdFilter() {}
   ...
   public:
    ...
    class Builder : public SubTable::Builder {
     public:
      ...
      CALLER_ATTACH static Builder* GetBuilder(ReadableFontData* data,
                                               int32_t offset,
                                               const CMapId& cmap_id);
      CALLER_ATTACH static Builder* GetBuilder(int32_t format,
                                               const CMapId& cmap_id);
     ...
     protected:
      Builder(ReadableFontData* data, int32_t format, const CMapId& cmap_id);
      Builder(WritableFontData* data, int32_t format, const CMapId& cmap_id);
  ...
  class CMapFormat0 : public CMap, public RefCounted<CMapFormat0> {
   public:
    ...
    class Builder : public CMap::Builder, public RefCounted<Builder> {
     public:
  ...
  class CMapFormat4 : public CMap, public RefCounted<CMapFormat4> {
   public:
     ...
     public:
      ...
      class Segment : public RefCounted<Segment> {
       public:
        ...
        Segment(int32_t start_count, int32_t end_count, int32_t id_delta,
        ...
        static CALLER_ATTACH std::vector<Ptr<Segment> >* DeepCopy(
            std::vector<Ptr<Segment> >* original);
    ...
    int32_t RetrieveGlyphId(int32_t segment, int32_t start_count,
                            int32_t character);
    virtual int32_t Language();
   ...
   private:
    ...
    static int32_t StartCode(ReadableFontData* data, int32_t seg_count,
                             int32_t index);
    static int32_t StartCodeOffset(int32_t seg_count);
    static int32_t EndCode(ReadableFontData* data, int32_t seg_count,
                           int32_t index);
    static int32_t IdDelta(ReadableFontData* data, int32_t seg_count,
                           int32_t index);
    static int32_t IdDeltaOffset(int32_t seg_count);
    static int32_t IdRangeOffset(ReadableFontData* data, int32_t seg_count,
                                 int32_t index);
