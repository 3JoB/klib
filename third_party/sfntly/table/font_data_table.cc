...
FontDataTable::FontDataTable(ReadableFontData* data) { data_ = data; }

FontDataTable::~FontDataTable() {}

ReadableFontData* FontDataTable::ReadFontData() { return data_; }

int32_t FontDataTable::DataLength() { return data_->Length(); }

int32_t FontDataTable::Serialize(OutputStream* os) { return data_->CopyTo(os); }
...
bool FontDataTable::Builder::ReadyToBuild() { return true; }
