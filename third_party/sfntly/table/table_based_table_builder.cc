...
bool TableBasedTableBuilder::SubReadyToSerialize() { return false; }

int32_t TableBasedTableBuilder::SubDataSizeToSerialize() { return 0; }

void TableBasedTableBuilder::SubDataSet() { table_ = NULL; }
...
Table* TableBasedTableBuilder::GetTable() {
  if (!table_) {
    ...
    if (data) table_.Attach(down_cast<Table*>(SubBuildTable(data)));
  }
  return table_;
}
