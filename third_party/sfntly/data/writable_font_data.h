...
class WritableFontData : public ReadableFontData {
 public:
  ...
  virtual int32_t WriteBytes(int32_t index, uint8_t* b, int32_t offset,
                             int32_t length);
  ...
  virtual int32_t WriteBytesPad(int32_t index, std::vector<uint8_t>* b,
                                int32_t offset, int32_t length, uint8_t pad);
