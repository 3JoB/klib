...
class ByteArray : virtual public RefCount {
 public:
  ...
  // Gets the maximum size of the array. This is the maximum number of bytes
  // that the array can hold and all of it may not be filled with data or even
  // fully allocated yet.
  ...
  // @return the number of bytes read from the buffer
  virtual int32_t Get(int32_t index, uint8_t* b, int32_t offset,
                      int32_t length);
  ...
  // Puts the specified bytes into the array at the given index. All of the
  // bytes specified are put into the array unless that would extend beyond the
  // length and the array isn't growable. The bytes to be put into the array are
  // those in the buffer from the given offset and for the given length.
  ...
  virtual int32_t Put(int32_t index, uint8_t* b, int32_t offset,
                      int32_t length);
 ...
 protected:
  ...
  virtual int32_t InternalPut(int32_t index, uint8_t* b, int32_t offset,
                              int32_t length) = 0;
  ...
  virtual int32_t InternalGet(int32_t index, uint8_t* b, int32_t offset,
                              int32_t length) = 0;
