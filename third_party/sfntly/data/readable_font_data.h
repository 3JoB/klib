...
class ReadableFontData : public FontData, public RefCounted<ReadableFontData> {
 public:
  ...
  static CALLER_ATTACH ReadableFontData* CreateReadableFontData(
  ...
  virtual int32_t ReadBytes(int32_t index, uint8_t* b, int32_t offset,
                            int32_t length);
  ...
  */
  ...
  //         otherwise
  int32_t SearchUShort(int32_t start_index, int32_t start_offset,
                       int32_t end_index, int32_t end_offset, int32_t length,
                       int32_t key);
  ...
  // @return the index of the start-end pairs in which the key was found; -1
  //         otherwise
  int32_t SearchULong(int32_t start_index, int32_t start_offset,
                      int32_t end_index, int32_t end_offset, int32_t length,
                      int32_t key);
