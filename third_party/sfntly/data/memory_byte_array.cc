...
MemoryByteArray::~MemoryByteArray() { Close(); }

int32_t MemoryByteArray::CopyTo(OutputStream* os, int32_t offset,
                                int32_t length) {
  assert(os);
...
int32_t MemoryByteArray::InternalPut(int32_t index, uint8_t* b, int32_t offset,
                                     int32_t length) {
  assert(b);
  Init();
...
int32_t MemoryByteArray::InternalGet(int32_t index, uint8_t* b, int32_t offset,
                                     int32_t length) {
  assert(b);
  Init();
