 ...
 */
void KLIB_EXPORT trim_left(std::string &str);
 ...
 */
std::string KLIB_EXPORT trim_left_copy(const std::string &str);

/**
 * @brief Remove all trailing spaces from the input
 * @param str: Input string
 */
void KLIB_EXPORT trim_right(std::string &str);
 ...
 * @return A trimmed copy of the input
 */
std::string KLIB_EXPORT trim_right_copy(const std::string &str);

/**
 * @brief Remove all leading and trailing spaces from the input
 * @param str: Input string
 */
void KLIB_EXPORT trim(std::string &str);
 ...
 * @return A trimmed copy of the input
 */
std::string KLIB_EXPORT trim_copy(const std::string &str);
 ...
 */
char32_t KLIB_EXPORT first_code_point(const std::string &str);
 ...
 */
char32_t KLIB_EXPORT last_code_point(const std::string &str);
 ...
 */
bool KLIB_EXPORT validate_utf8(const std::string &str);
 ...
 */
bool KLIB_EXPORT validate_utf16(const std::u16string &str);
 ...
 */
std::u16string KLIB_EXPORT utf8_to_utf16(const std::string &str);
 ...
 */
std::string KLIB_EXPORT utf16_to_utf8(const std::u16string &str);
 ...
 */
std::u32string KLIB_EXPORT utf8_to_utf32(const std::string &str);
 ...
 * @return The converted UTF-32 encoded string
 */
std::wstring KLIB_EXPORT utf8_to_utf32_w(const std::string &str);
 ...
 * @return The converted UTF-8 encoded string
 */
std::string KLIB_EXPORT utf32_to_utf8(const std::u32string &str);
 ...
 * @return The converted UTF-8 encoded string
 */
std::string KLIB_EXPORT utf32_to_utf8_w(const std::wstring &str);
