...
TEST_CASE("aes_256_cbc", "[crypto]") {
  ...
  CHECK(klib::aes_256_encrypt_base64("Advanced Encryption Standard",
                                     "1234567890abcdef1234567890abcdef", iv) ==
        "x/+2Hp/n7E4BKs4p5YoCwvys4O2Ugt39cJ/rWEwpBjY=");

  CHECK(klib::aes_256_decrypt_base64(
            "x/+2Hp/n7E4BKs4p5YoCwvys4O2Ugt39cJ/rWEwpBjY=",
  ...
  CHECK(klib::aes_256_decrypt_base64(encrypt, hash) ==
        "Advanced Encryption Standard");

  CHECK(klib::aes_256_encrypt_base64(
